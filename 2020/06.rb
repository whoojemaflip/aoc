...
assert test_input.sum { |group| group.unique_answers } == 11
assert test_input.map { |group| group.everyone_answers }.sum == 6

puts "Part 1: " + input.sum { |group| group.unique_answers }.to_s
puts "Part 2: " + input.map { |group| group.everyone_answers }.sum.to_s
